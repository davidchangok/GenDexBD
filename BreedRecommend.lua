...
local COMMUNITY_BREED_BONUS = {
    ...
    [418] = "B",     -- 水蛇: B/B(S/S也推荐),毒牙+反击体系,Burst>钻地
    -- === 蟹 ===
    [388] = "H",     -- 海滨蟹: H/H,双治疗坦克翻身,NEEDS_SPEED不碾压H/H
    [423] = "B",     -- 熔岩蟹: B/B,Shell Shield攻强缩放+Magma Wave工具宠
    ...
    -- === 猫头鹰/鸟 ===
    [507] = "B",     -- 羽冠猫头鹰: B/B,飞行×1.3速+3×POWER均衡
    ...
    [3049] = "H/B",  -- 脉动蛆虫: H/B,吸血%敌人HP不吃Power,爆裂%自己HP吃血量
    [3038] = "B",    -- 不朽死亡蟑螂: B/B,乱舞+蝇群+假死(B4碾压B7天启流),B/B 874>H/P 583
