...
local W_FORCE = 3.0
local W_COMMUNITY = 4.0  -- 社区例外加权（软覆盖，>FORCE=3.0但独立生效）
                          -- 4.0 × 100 = +400分加成，翻转较大差距的排名
local SCALE = 100
...
local COMMUNITY_BREED_BONUS = {
    ...
    [480] = "S",     -- 黄宝石钻孔幼蛛: S/S,蜘蛛家族控场型,网+毒+幼蛛标准组合
    [554] = "S",     -- 赤红幼岩蛛: S/S,蜘蛛控场先手网+毒体系
    [637] = "S",     -- 敏捷的洞穴蛛: S/S,蜘蛛控场型全S/S
    [699] = "S",     -- 跳蛛: S/S,蜘蛛跳蛛控场先手
    -- === 老鼠家族 ===
    ...
    [479] = "S",     -- 小野兔: S/S,野兔家族全S/S,Dodge+Flurry+Burrow依赖先手
    [487] = "S",     -- 高山花栗鼠: S/S,花栗鼠全S/S,坚果弹幕+奔踏+蜷伏
    [725] = "S",     -- 高山狐狸崽: S/S,狐狸家族S/S共识,乱舞+奔踏+躲闪
    [730] = "S",     -- 多莱兔仔: S/S,兔子家族S/S,同137/378
    [1729] = "S",    -- 绿尾野兔: S/S,野兔全S/S,速度碾压同族
    [1743] = "S",    -- 黑脚狐幼崽: S/S,狐狸家族S/S共识
    ...
    [449] = "S",     -- 棕色土拨鼠: S/S,草原土拨鼠同族,无P/B品种可选,S/S最优
    -- === 甲虫家族 ===
    ...
    [713] = "H",     -- 软壳幼龟: H/H,龟类坦克型,甲壳护盾+生存体系
    ...
    [471] = "P",     -- 机械小鸡/斧喙: P/P社区确认(Xu-Fu's B-Tier),机械家族P/P共识,AlphaStrike+Haywire
