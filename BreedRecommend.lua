...
local COMMUNITY_BREED_BONUS = {
    ...
    -- 2026-07-21 全报告分析新增 (9条)
    [519] = "H", -- 邪焰: H/H社区共识,灼燃大地+献祭+焚烧DOT叠加需血量生存,无P/P可选
    [429] = "P", -- 熔火甲虫: P/P社区"especially P/P",不同于415火甲虫,有P/P选P/P
    [626] = "P", -- 蝙蝠: P/P社区共识,鲁莽之击spam+鹰眼,无防御技=最大化输出
    [493] = "H/P",-- 闪光湖蜗牛: H/P社区共识,305攻=最高攻蜗牛,吸收吃Power+甲壳护盾吃HP
    [507] = "B", -- 羽冠猫头鹰: B/B社区共识,飞行×1.3速+3×POWER均衡,B/B合理
    [420] = "H/P",-- 蟾蜍: H/P唯一青蛙/蟾蜍有H/P品种,治疗波攻缩放+净化雨
    [388] = "H", -- 海滨蟹: H/H社区共识,双治疗坦克翻身,NEEDS_SPEED不碾压H/H
    [509] = "H/S",-- 袖珍沼泽兽: H/S社区共识,痛殴先手晕+鞭笞额外攻击,元素均衡偏速
    [627] = "H/P",-- 被感染的松鼠: H/P社区共识,邪爆HP%+吞噬,亡灵偏攻血量品种
}
