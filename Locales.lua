...
local strings = {
    ...
    SLASH_HELP            = { zhCN = "GenDexBD 命令: /gbbd 打开设置, /gbbd report 生成全物种报告", enUS = "GenDexBD commands: /gbbd settings, /gbbd report" },
    ...
    SCENARIO_PVE_HEADER    = { zhCN = "══ PvE 推荐 ══",       enUS = "══ PvE Best ══" },
    SCENARIO_PVP_HEADER    = { zhCN = "══ PvP 推荐 ══",       enUS = "══ PvP Best ══" },
...
addonTable.AUTO_TAG_KEYWORDS = {
    NEEDS_SPEED = {
        ...
        enUS = {
            ...
            "deflect","blink","vanish","ethereal","stealth","invisib",
            "soar",
            ...
            "smoke.*bomb","block.*attack","bubble","guard.*attack",
            "soothe","drowsy",
        },
    },
    SCALES_POWER = {
        zhCN = {
            ...
            "每一击","每击中一次","每次使用.*提高","1.2次","1.3次","1.2把","1.3把",
            "每回合","每轮.*造成","每轮.*额外","持续.*伤害","每回合造成","额外.*每轮","轮后.*造成",
            "流血","割裂","出血",
            ...
            "冻伤","低温",
            "诅咒","鬼影",
            "斩杀","处决","低于.*双倍","低于.*加倍","如果.*中毒.*双倍",
            "毁灭","湮灭","抹除","能量涌动","爆发","愤怒","狂怒",
            "审判","大灾变",
            "嚎叫","增幅","激怒","狂暴","嗜血","咆哮",
            "吸血","虹吸","吸取.*生命","生命汲取","法力吸取",
            "造成的.*伤害.*提高","造成的.*伤害.*提升",
            "攻击力.*提升","攻击力.*提高",
            "使.*伤害.*提高","使.*伤害.*提升","额外造成","双倍.*伤害",
        },
        enUS = {
            ...
            "each hit","each strike","each time it hits","each use.*increases","damage.*increases.*each",
            ...
            "drain","leech","siphon","vampir","life.*steal",
            "damage increased","damage boost","power boost",
            "increases.*damage.*dealt","deal.*more.*damage","deal.*additional.*damage",
            "double.*damage",
        },
    },
    SCALES_HEALTH = {
        zhCN = {
            "治疗","治愈","回复.*生命","恢复.*生命","疗伤","康复","再生","回春","绽放","开花",
            "重振","提神","滋养","绷带","急救",
            ...
            "最大生命.*回复",
            "吞食","吞噬","盛宴",
            -- 移除 "进食": 过匹配 — "进食昏迷"是睡眠CC非治疗
            "牺牲","自爆","爆炸","殉道","引爆","内爆",
            "杀死.*施法者","杀死.*使用者","总生命值","剩余.*生命值",
            "护盾.*吸收","屏障","结界","神盾","壁垒","格挡","阻挡.*攻击",
            "吸收.*伤害","减免.*伤害","伤害降低","降低.*伤害","受到.*伤害.*降低","受到.*伤害.*减少",
            "伤害上限","防止.*伤害",
            "坚毅","承受","坚韧","韧性",
            "守护者","保护者","庇护所","祝福","净化",
        },
